...
@NamedQueries({
    ...
    @NamedQuery(name = "TipoPlanilla.findByCodigoDescripcionPlaxmesIdempCedula", query = "SELECT t FROM TipoPlanilla t JOIN t.empleados e WHERE UPPER(t.codigo) like :codigo and UPPER(t.descripcion) like :descripcion and UPPER(t.planillaPorMes) like :plaxmes and UPPER(e.id) like :idemp and UPPER(e.cedula) like :cedula", hints = @QueryHint(name = "eclipselink.refresh", value = "true")),})
