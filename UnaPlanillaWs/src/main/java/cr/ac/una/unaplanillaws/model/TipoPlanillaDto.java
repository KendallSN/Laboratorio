 ...
 * @author cbcar
 */
@Schema(description = "TipoPlanilla")

public class TipoPlanillaDto {

    @Schema(description = "Id tipo planilla", example = "1")
    private Long id;
    @Schema(description = "Codigo planilla mensual", example = "afea457")
    public String codigo;
    @Schema(description = "Numero ")
    public String descripcion;
    @Schema(description = "Tipo planilla mensual")
    public Integer planillaPorMes;
    @Schema(description = "Año de la ultima tipo planilla ")
    private Integer anoUltimaPlanilla;
    @Schema(description = "Mes de la ultima tipo planilla ")
    private Integer mesUltimaPlanilla;
    @Schema(description = "Dia de la ultima tipo planilla ")
    private Integer numeroUltimaPlanilla;
    @Schema(description = "Indica el estado del tipo planilla(A:activo, I:inactivo)", example = "A", allowableValues = "A,I")
